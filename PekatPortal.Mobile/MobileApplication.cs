...
namespace PekatPortal.Mobile {
    ...
    public partial class PekatPortalMobileApplication : MobileApplication {
        ...
        private PekatPortal.Module.Mobile.PekatPortalMobileModule module4;
        ...
        static PekatPortalMobileApplication() {
        ...
        #endregion
        public PekatPortalMobileApplication() {
        ...
        private void PekatPortalMobileApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module4 = new PekatPortal.Module.Mobile.PekatPortalMobileModule();
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.PekatPortalMobileApplication_DatabaseVersionMismatch);
