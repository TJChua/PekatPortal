...
namespace PekatPortal.Module.BusinessObjects
{
    ...
    public class vw_ContactPerson : XPLiteObject
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        public vw_ContactPerson(Session session)
            : base(session)
        {
        }
        ...
        [Key]
        [Browsable(true)]
        [XafDisplayName("CntctCode")]
        [Appearance("CntctCode", Enabled = false)]
        ...
        [Association("vw_CustomerList-vw_ContactPerson")]
        ...
        [Appearance("Email", Enabled = false)]
        [VisibleInDetailView(false), VisibleInListView(true), VisibleInLookupListView(false)]
        public string Email
        {
            get; set;
