...
namespace PekatPortal.Module.BusinessObjects
{
    ...
    public class vw_ProjectList : XPLiteObject
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        public vw_ProjectList(Session session)
            : base(session)
        {
        }
        ...
        [Appearance("PrjCode", Enabled = false)]
        ...
        //[Browsable(true)]
        [XafDisplayName("Project Name")]
        [Appearance("PrjName", Enabled = false)]
        ...
        //[Browsable(true)]
        [XafDisplayName("Project Name")]
        [Appearance("Project", Enabled = false)]
