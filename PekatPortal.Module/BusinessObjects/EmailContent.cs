...
namespace PekatPortal.Module.BusinessObjects
{
    ...
    public class EmailContent : XPObject
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        public EmailContent(Session session)
            : base(session)
        {
        }
        ...
        public string EmailType
        {
            ...
            set
            {
                SetPropertyValue("EmailType", ref _EmailType, value);
            }
        }
        ...
        public string EmailTitle
        {
            ...
            set
            {
                SetPropertyValue("EmailTitle", ref _EmailTitle, value);
            }
        }
        ...
        [Association("EmailContent-EmailHistory")]//Save Detail together with Header.
        [XafDisplayName("Email History")]
        public XPCollection<EmailHistory> EmailHistory
        {
            get { return GetCollection<EmailHistory>("EmailHistory"); }
        }
