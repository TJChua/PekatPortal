...
namespace PekatPortal.Module.BusinessObjects
{
    ...
    public class vw_ODLN : XPLiteObject
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        public vw_ODLN(Session session)
            : base(session)
        {
        }
        ...
        [Association("vw_ODLN-vw_DLN1")]//Save Detail together with Header.
        [XafDisplayName("Delivery Detail")]
        public XPCollection<vw_DLN1> vw_DLN1
        {
            get { return GetCollection<vw_DLN1>("vw_DLN1"); }
        }
