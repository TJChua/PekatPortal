...
namespace PekatPortal.Web
{
    ...
    public partial class PekatPortalAspNetApplication : WebApplication
    {
        //private static NonPersistentTypeInfoSource nonPersistentTypeInfoSource;
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private PekatPortal.Module.PekatPortalModule module3;
        private PekatPortal.Module.Web.PekatPortalAspNetModule module4;
        ...
        #endregion
        public PekatPortalAspNetApplication()
        {
            InitializeComponent();
            InitializeDefaults();

            //((SecurityStrategyComplex)Security).AnonymousAllowedTypes.Add(typeof(Company));
        }
        ...
        private void PekatPortalAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e)
        {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
        ...
        private void InitializeComponent()
        {
            ...
            this.module4 = new PekatPortal.Module.Web.PekatPortalAspNetModule();
            this.module3 = new PekatPortal.Module.PekatPortalModule();
            this.securityModule1 = new DevExpress.ExpressApp.Security.SecurityModule();
            this.securityStrategyComplex1 = new DevExpress.ExpressApp.Security.SecurityStrategyComplex();
            this.pekatPortalModule1 = new PekatPortal.Module.PekatPortalModule();
            ...
            this.securityStrategyComplex1.UserType = typeof(PekatPortal.Module.BusinessObjects.SystemUsers);
            // 
            // authenticationStandard1
            // 
            this.authenticationStandard1.LogonParametersType = typeof(DevExpress.ExpressApp.Security.AuthenticationStandardLogonParameters);
            // 
            // PekatPortalAspNetApplication
            // 
            this.ApplicationName = "PekatPortal";
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.PekatPortalAspNetApplication_DatabaseVersionMismatch);
